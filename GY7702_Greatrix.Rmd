...
By way of an explanation, ```newCases_day_before``` states the cases the day before ```specimen_date ``` . ```newCasesBySpecimenDate``` states the cases on the ```specimen_date```. This allows ```newCases_day_before/newCasesBySpecimenDate``` to efficiently calculate change in COVID cases over 2 days, across 1 row.
